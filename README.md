...
1. **Text Preparation**:
    - Extract the **Edited Ending** (generated text from your model's output).
    - Compare it against:
       - The **Original Ending** to assess the model's ability to preserve narrative coherence.
       - The **Premise** to ensure the story aligns with the initial context.
       - The **Counterfactual Statement** to verify the model's adeptness in reflecting the counterfactual change.

2. **Compute ROUGE Scores**:
    - Calculate BLEU, ROUGE-1, ROUGE-2, ROUGE-L, and ROUGE-LSUM scores between the Edited Endings and:
      - The Premise.
      - The Original Ending.
      - The Counterfactual Statement.
    - Ensure consistent preprocessing (e.g., tokenization) of texts before score computation.
